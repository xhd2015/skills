...
Skips cmd/ paths under github.com/xhd2015/skills/ (thin mains / CLIs).
...
MODULE_PREFIX = "github.com/xhd2015/skills/"
...
def main() -> int:
    ...
    for line in path.read_text().splitlines():
        ...
        # Product libs only; thin cmd/ entrypoints are noisy and less useful in the table.
